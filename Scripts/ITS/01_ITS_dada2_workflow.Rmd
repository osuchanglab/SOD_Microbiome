...
knitr::opts_knit$set(root.dir = "~/Documents/Postdoc/SOD_microbiome_analysis/Data/ITS")
...
sample.names <- gsub("_L001_R1.fastq.gz", "", basename(fnFs))
...
``` {r assignTaxonomy}
itsdb.ref <- "metadata_dbs/sh_general_release_dynamic_all_04.04.2024.fasta"  
...
``` {r assignTaxonomy}
itsdb.ref <- "metadata_dbs/sh_general_release_dynamic_all_25.07.2023.fasta"  
taxa <- assignTaxonomy(seqtab.nochim, itsdb.ref, multithread = TRUE, minBoot = 0, outputBootstraps = TRUE, verbose=TRUE, tryRC = FALSE)
...
### Let's try earlier db but fungi only
``` {r assignTaxonomy}
itsdb.ref <- "metadata_dbs/sh_general_release_dynamic_18.07.2023.fasta"  
taxa <- assignTaxonomy(seqtab.nochim, itsdb.ref, multithread = TRUE, minBoot = 0, outputBootstraps = TRUE, verbose=TRUE, tryRC = FALSE)

taxa.print <- taxa  
rownames(taxa.print) <- NULL

write.table(taxa, file="dada2_outputs/its_taxa_07_23db_fungi.out",sep="\t",quote=F)
```
...
write.table(taxa, file="dada2_outputs/its_taxa_tryRC_07_23db_fungi.out",sep="\t",quote=F)
```
